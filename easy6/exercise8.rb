...
# p
# Given an array with one value that is duplicated, find the value that is
# duplicated.

# Rules:
# Input: array
# Output: Value that is duplicated
# - Only one value will be duplicated in input
...
# - Iterate over arr and check each element to see if it's been duplicated
